...
class User {
	...
	function getOneScrobble($userid, $scrobble) {

	$data = Server::getSingleScrobble($userid, $scrobble);
	...
	function getAvatar($size = 64) {
		...
		return 'https://www.libravatar.org/avatar/' . md5(strtolower($this->email)) . '?s=' . $size . '&d=monsterid';
	}
